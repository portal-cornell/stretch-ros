...
class BC(pl.LightningModule):
    ...
    def __init__(self, skill_name, joint_state_dims, state_action_dims, training_path,
                 ...
                 compress_img=True, img_comp_dim=32, js_modifications="", train_cnn=False):
        super().__init__()
        ...
        # self.augment = transforms.Compose([transforms.RandomCrop(size=200, pad_if_needed=True)])
    ...
    def train_dataloader(self):
        ...
        train_dataloader = DataLoader(
            training_data, num_workers=self.num_workers, batch_size=self.batch_size, drop_last=True)
    ...
    def training_step(self, train_batch, batch_idx):
        ...
        return {"loss": loss_mean, "acc": acc_mean}
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        acc = self.accuracy(predicted_action, actual_action)
        acc_mean = torch.mean(acc)
        return {"val_loss": loss_mean, "val_acc": acc_mean}
