...
class BC(pl.LightningModule):
    def __init__(
        ...
        self.accuracy = torchmetrics.Accuracy(
            task="multiclass", num_classes=state_action_dims, top_k=1
        )
    ...
    def train_dataloader(self):
        training_data = VisuomotorDataset(
            ...
            csv_file=self.training_path,
            transform=self.resnet_transform,
    ...
    def training_step(self, train_batch, batch_idx):
        image, joint_state, key_pressed = (
            train_batch["image"],
            train_batch["joint_states"],
            train_batch["key_pressed"],
        )
    ...
    def validation_step(self, val_batch, batch_idx):
        image, joint_state, key_pressed = (
            val_batch["image"],
            val_batch["joint_states"],
            val_batch["key_pressed"],
        )
