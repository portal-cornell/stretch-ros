...
class JointMover():
    ...
    def reset(self):
        target_position_list = [-0.1871456561220482, -0.0030679615757712823, 0.0, 0.0, \
            0.35962665366404195, 0.0006300918493041412, 0.0006300918493041412, 0.0006300918493041412, \
                0.0006300918493041412, 2.5643045504154967, -1.8062985822376425, -0.7427547847723526]

        joint_name_list = ['joint_wrist_pitch', 'joint_wrist_roll', 
        'joint_right_wheel', 'joint_left_wheel', 'joint_lift', 'joint_arm_l3', 'joint_arm_l2', 'joint_arm_l1', 'joint_arm_l0', 
