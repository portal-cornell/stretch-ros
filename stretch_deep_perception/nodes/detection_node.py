...
class DetectionNode:
    ...
    def image_callback(self, ros_rgb_image, ros_depth_image, rgb_camera_info):
        ...
        print('image time stamp', ros_rgb_image.header.stamp)
        print('depth time stamp', ros_depth_image.header.stamp)
        print('camera_info time stamp', rgb_camera_info.header.stamp)
        # print('ros_pointcloud time stamp', ros_pointcloud.header.stamp)
        # input("ajhajhhajs")
    ...
    def main(self):
        ...
        self.visualize_point_cloud_pub = rospy.Publisher('/yolov3/point_cloud2', PointCloud2, queue_size=1)
        self.visualize_img_pub = rospy.Publisher('/' + self.topic_base_name + '/image', Image, queue_size=1)
